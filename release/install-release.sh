...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/ximliu/alliswell2day-v2ray-core-back-up/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/ximliu/alliswell2day-v2ray-core-back-up/releases/latest"
